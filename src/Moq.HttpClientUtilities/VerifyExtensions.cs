...
namespace Moq.HttpClientUtilities
{
    ...
    {
        /// <summary>
        /// Verifies that a HTTP request was sent to the specified uri fragment with the specified verb.
        /// Throws an exception if the conditions were not met. 
        /// </summary>
        /// <param name="method">The HTTP method (GET, POST, ...)</param>
        /// <param name="uri">The uri fragment (excluding the base path)</param>
