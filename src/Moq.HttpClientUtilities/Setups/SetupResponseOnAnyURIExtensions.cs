...
namespace Moq.HttpClientUtilities
{
    public static class SetupResponseOnAnyURIExtensions
    {
        ...
        public static void SetupResponseOnAnyURI(this Mock<HttpMessageHandler> handler,
            HttpMethod method, HttpStatusCode statusCode, object content, Serialization mode = Serialization.Json,
            IList<HttpRequestMessage> sentRequests = null) =>
            SetupResponseOnAnyURI(handler, method, statusCode, content.Serialize(mode), sentRequests);
